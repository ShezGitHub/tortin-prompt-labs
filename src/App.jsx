              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 14, marginBottom: 20 }}>
                ...
                <div style={{ border: "1px solid #f0e0e0", borderRadius: 14, overflow: "hidden", background: "#fff", boxShadow: "0 2px 8px rgba(0,0,0,0.03)" }}>
                  ...
                  <div style={{ padding: isImageLesson ? 0 : 18, minHeight: 180 }}>
                    {loadingWeak ? (
                      ...
                      <div style={{ fontSize: 13, color: "#666", lineHeight: 1.85, fontFamily: SF }}>
                        <ReactMarkdown remarkPlugins={[remarkGfm]}>{weakResponse}</ReactMarkdown>
                      </div>
                    ) : null}
                  </div>
                </div>
                ...
                <div style={{ border: `1px solid rgba(192,57,43,0.22)`, borderRadius: 14, overflow: "hidden", background: "#fff", boxShadow: "0 2px 16px rgba(192,57,43,0.08)" }}>
                  <div style={{ padding: "14px 18px", borderBottom: `1px solid rgba(192,57,43,0.1)`, background: RLL }}>
                    ...
                    <div style={{ fontSize: 12, color: "#a04040", fontFamily: SF, lineHeight: 1.65 }}>
                      {improvedPrompt ? <ReactMarkdown remarkPlugins={[remarkGfm]}>{improvedPrompt}</ReactMarkdown> : "Generating improved prompt…"}
                    </div>
                  </div>
                  <div style={{ padding: isImageLesson ? 0 : 18, minHeight: 180 }}>
                    {loadingUser ? (
                      ...
                      <div style={{ fontSize: 13, color: "#333", lineHeight: 1.85, fontFamily: SF }}>
                        <ReactMarkdown remarkPlugins={[remarkGfm]}>{userResponse}</ReactMarkdown>
                      </div>
                    ) : null}
                  </div>
                </div>
